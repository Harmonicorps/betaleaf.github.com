...
**Notes**  
  ...
  * You can view the [<i class="fa fa-file-code-o"></i> Source Code](https://github.com/BetaLeaf/SoundBoard/blob/master/SoundBoard.au3) on [<i class="fa fa-code-fork"></i> GitHub](https://github.com/BetaLeaf/SoundBoard/).  
