---
layout: page
title: InvokerHelper - Manual
date: 2015-09-22 03:07
author: BetaLeaf
comments: true
categories: [Manuals]
tags: [Manual]
permalink: /InvokerHelper/.title
---
First, if you don't have an INI file in the same directory, run InvokerHelper and an INI file will be created. It will automatically load the default binds.
If you want to make changes, Close Invoker Helper and open the INI file with notepad.exe.
For every Invoker Spell you see, you need to set a key to bind it to. For example, to use coldsnap, press y.
The last 6 binds need match the quickcast binds in Dota 2.
Binds should be lowercase and enclosed with &#123; &#125; if bind is a multi-letter key, such as F1. &#123;f1&#125; would be a valid entry.
<p style="text-align: left;"><strong>Default Binds</strong></p>
[Binds]
ColdSnap=y
GhostWalk=p
IceWall=i
...
SunStrike=t
DeafeningBlast=r
<p style="text-align: left;">Quas=q
Wex=w
Exort=e
Invoke=r
Skill1=d
