...
---
  ...
  - [**Download** Kishin Flavor Just Ask](https://github.com/BetaLeaf/MapleStory-JustAsk/blob/master/JustAsk%20Kishin.exe?raw=true)  
  - [**Download** HS Flavor Just Ask](https://github.com/BetaLeaf/MapleStory-JustAsk/blob/master/JustAsk%20HS.exe?raw=true)  
...
**Instructions:**  
  ...
  - Extract into a separate folder and run the exe for the mode you want. The first run will install the necessary files in the current directory. Set the INI file, save, and then relaunch the exe.  
  - Currently, there are 3 flavors. One for HS, One for Kishin, and one for Bishop (All Party skills).  

**How to use:**  

  - Just have anyone in PARTY chat say "hs" or "kishin" (without quotes) and your character will use those skills. Which word is used depends on which exe you used.  
  - Maplestory must be in Windowed mode or this will not work.  
  - If you are using the Bishop Flavor, you can say "commands" for an entire list of commands.  
  - the "Fix100" command is only available on the Bishop Flavor and lets you reset the counter to MapleStory's 100 attack limitation by using Mystic Door and going in and out.  
