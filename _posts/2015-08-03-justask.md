...
---
<div class="body">
<div><a href="http://betaleaf.net/wp-content/uploads/2015/08/JustAsk.zip"><strong>Download</strong> JustAsk</a>
<a href="http://betaleaf.net/wp-content/uploads/2015/08/JustAsk-Source.zip"><strong>Download</strong> Source</a></div>
<div></div>
<div>

<strong><strong><strong>How do I use this?</strong></strong></strong>
<ul>
	<li>Just have anyone in PARTY chat say "hs" or "kishin" (without quotes) and your character will use those skills. Which word is used depends on which exe you used. Maplestory must be in Windowed mode or this will not work.</li>
	<li>If you are using the Bishop Flavor, you can say "commands" for an entire list of commands.</li>
</ul>
<strong>Instructions:</strong>
<ul>
	<li>Extract into a separate folder and run the exe for the mode you want. The first run will install the necessary files in the current directory. Set the INI file, save, and then relaunch the exe.</li>
	<li>Currently, there are 3 flavors. One for HS, One for Kishin, and one for Bishop (All Party skills).</li>
</ul>
...
sit=t
<ul>
	<li>In this Example, we can see that quit is set to Shift+Escape. When you press this key, Just Ask will terminate itself.</li>
	<li>You can also see Holy symbol is set to Space.</li>
	<li>If you set sit=off then the sit function will not be used.</li>
</ul>
<table border="1">
<tbody>
<tr>
